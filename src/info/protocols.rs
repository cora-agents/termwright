...
fn all_methods() -> Vec<MethodInfo> {
    vec![
        ...
        MethodInfo {
            ...
            params: "null",
            response: "{protocol_version, termwright_version, pid, child_pid}",
            example_request: r#"{"id":1,"method":"handshake","params":null}"#,
            example_response: r#"{"id":1,"result":{"protocol_version":1,"termwright_version":"0.1.0","pid":12345,"child_pid":12346}}"#,
        },
        MethodInfo {
            name: "status",
            category: "session",
        ...
        MethodInfo {
            ...
            params: r#"{format: "text"|"json"|"json_compact"|"ansi"}"#,
            response: "string (text/ansi) or object (json)",
        ...
        MethodInfo {
            name: "paste",
            category: "input",
            brief: "Paste text using bracketed paste mode (ESC[200~ ... ESC[201~)",
            params: r#"{text: string}"#,
            response: "null",
            example_request: r#"{"id":1,"method":"paste","params":{"text":"pasted content"}}"#,
            example_response: r#"{"id":1,"result":null}"#,
        },
        MethodInfo {
            name: "press",
        ...
        MethodInfo {
            name: "mouse_drag",
            category: "input",
            brief: "Drag mouse from one position to another",
            params: r#"{start_row: number, start_col: number, end_row: number, end_col: number, button?: "left"|"right"|"middle"}"#,
            response: "null",
            example_request: r#"{"id":1,"method":"mouse_drag","params":{"start_row":1,"start_col":5,"end_row":1,"end_col":20}}"#,
            example_response: r#"{"id":1,"result":null}"#,
        },
        MethodInfo {
            name: "mouse_double_click",
            category: "input",
            brief: "Double-click mouse at position",
            params: r#"{row: number, col: number, button?: "left"|"right"|"middle"}"#,
            response: "null",
            example_request: r#"{"id":1,"method":"mouse_double_click","params":{"row":5,"col":10}}"#,
            example_response: r#"{"id":1,"result":null}"#,
        },
        MethodInfo {
            name: "mouse_scroll",
        ...
        MethodInfo {
            name: "cell_at",
            category: "inspect",
            brief: "Get cell attributes at position",
            params: r#"{row: number, col: number}"#,
            response: r#"{char, fg: Color, bg: Color, attrs: {bold, italic, underline, inverse}}"#,
            example_request: r#"{"id":1,"method":"cell_at","params":{"row":0,"col":5}}"#,
            example_response: r#"{"id":1,"result":{"char":"H","fg":{"Default":{}},"bg":{"Default":{}},"attrs":{"bold":false,"italic":false,"underline":false,"inverse":false}}}"#,
        },
        MethodInfo {
            name: "screen_region",
            category: "inspect",
            brief: "Get screen content for a rectangular region",
            params: r#"{start_row: number, start_col: number, end_row: number, end_col: number, format?: "text"|"json"}"#,
            response: "string (text) or [[Cell]] (json)",
            example_request: r#"{"id":1,"method":"screen_region","params":{"start_row":0,"start_col":0,"end_row":2,"end_col":10}}"#,
            example_response: r#"{"id":1,"result":"Hello\nWorld"}"#,
        },
        MethodInfo {
