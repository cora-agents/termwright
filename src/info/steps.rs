        ...
        StepInfo {
            ...
            params: vec![
                ParamInfo {
                    ...
                    r#type: "number",
                    default: None,
                    description: "Start row position",
                },
                ParamInfo {
                    name: "startCol",
                    required: true,
                    r#type: "number",
                    default: None,
                    description: "Start column position",
                },
                ParamInfo {
                    name: "endRow",
                    required: true,
                ...
                ParamInfo {
                    ...
                    r#type: "number",
                    default: None,
                    description: "End column position",
                },
                ParamInfo {
                    name: "button",
                    required: false,
            ...
            example: r#"mouseDrag: {startRow: 1, startCol: 5, endRow: 1, endCol: 20}"#,
            tips: vec!["Sends mouse-down, move, mouse-up sequence"],
        },
        StepInfo {
            name: "mouseDoubleClick",
            category: "input",
            brief: "Double-click at a position",
            params: vec![
                ParamInfo {
                    name: "row",
                    required: true,
            ...
            example: r#"mouseDoubleClick: {row: 5, col: 10}"#,
            tips: vec!["Sends two rapid click events"],
        },
